/*
 * Register definition file for s3c64xx/s3c244x SoC CAMIF driver
 *
...
#define  CISCCTRL_MAIN_RATIO_MASK		(0xff << 16 | 0xff)
...
void camif_hw_clear_last_capture_end(struct camif_dev *camif);
void camif_hw_set_interrupt_mask(struct camif_dev *camif);
void camif_hw_capture_start(struct camif_dev *camif);
void camif_hw_capture_stop(struct camif_dev *camif);
...
//void camif_hw_set_dma_window(struct camif_dev *camif, struct camif_frame *f);
