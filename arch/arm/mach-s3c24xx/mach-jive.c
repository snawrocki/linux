...
static void jive_power_off(void)
{
	...
	gpio_request_one(S3C2410_GPC(5), GPIOF_INIT_HIGH, NULL);
...
static void __init jive_machine_init(void)
{
	...
	gpio_request_one(S3C2410_GPB(6), GPIOF_INIT_LOW, NULL);
	gpio_free(S3C2410_GPB(6));

	gpio_request_one(S3C2410_GPG(8), GPIOF_INIT_HIGH, NULL);
